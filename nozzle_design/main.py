...
z = 5
x,y, A,throat_area, thetas, throat_location_x, throat_location_y = geometry.initialize_nozzle_geometry("nozzle_design/nozzle-geometry.csv", 10, 3, only_divergent=True)
...
with open("profile_moc.csv", "w", newline="") as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(["x","y" ,"P", "M"])
    for xi, yi, Pi, Mi in zip(x, y, P, M):
        writer.writerow([xi, yi, Pi, Mi])